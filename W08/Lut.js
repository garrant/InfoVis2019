...
THREE.Lut = function ( colormap, numberofcolors ) {
    ...
    //map1 =  THREE.ColorMapKeywords[ colormap ]
    

    //document.write(map1[1][0]);
...
THREE.Lut.prototype = {
	...
	//document.write(THREE.ColorMapKeywords[ this.mapname ]);
	//document.write(this.map[1][0]);
	//document.write(this.map.length+'\n');
	//document.write(this.map[255][0]);
